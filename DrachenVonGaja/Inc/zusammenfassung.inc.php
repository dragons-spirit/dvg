...
<!-- Element und Heimatgebiet auswählen -->
...
<?php
    if(isset($_POST["button_erdelement"]))
        ...
        <?php
                ...
                echo "Hier müsste etwas dastehen!";
                }
    ...
    if(isset($_POST["button_wasserelement"]))
        ...
        #Zeige Gebiete für Wasserelement
        ?>
        <h3 align="center">Auswahl des Heimatgebietes</h3>
        ...
        #Zeige Gebiete für Feuerelement
        ?>
        <h3 align="center">Auswahl des Heimatgebietes</h3>
