...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000562fd5e1000000015285988b(
...
class phpbbtemplatetwiglexer_00000000562fd5e1000000015285988b extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder587377f86ad95849222518 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer587377f86ada4563303237 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties587377f86ad67275928355 = array(
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, 'set_environment', array('env' => $env), $this->initializer587377f86ada4563303237);

        return $this->valueHolder587377f86ad95849222518->set_environment($env);
    }
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer587377f86ada4563303237);

        return $this->valueHolder587377f86ad95849222518->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer587377f86ada4563303237);

        return $this->valueHolder587377f86ad95849222518->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer587377f86ada4563303237 = $initializer;
    }
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__get', array('name' => $name), $this->initializer587377f86ada4563303237);

        if (isset(self::$publicProperties587377f86ad67275928355[$name])) {
            return $this->valueHolder587377f86ad95849222518->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder587377f86ad95849222518;
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer587377f86ada4563303237);
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__isset', array('name' => $name), $this->initializer587377f86ada4563303237);
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__unset', array('name' => $name), $this->initializer587377f86ada4563303237);
    ...
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__clone', array(), $this->initializer587377f86ada4563303237);

        $this->valueHolder587377f86ad95849222518 = clone $this->valueHolder587377f86ad95849222518;
    }

    public function __sleep()
    {
        $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, '__sleep', array(), $this->initializer587377f86ada4563303237);

        return array('valueHolder587377f86ad95849222518');
    }
    ...
    {
        return $this->initializer587377f86ada4563303237;
    }
    ...
    {
        return $this->initializer587377f86ada4563303237 && $this->initializer587377f86ada4563303237->__invoke($this->valueHolder587377f86ad95849222518, $this, 'initializeProxy', array(), $this->initializer587377f86ada4563303237);
    }
    ...
    {
        return null !== $this->valueHolder587377f86ad95849222518;
    }
    ...
    {
        return $this->valueHolder587377f86ad95849222518;
    }
