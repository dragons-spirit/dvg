...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000c056159000000013887be67(
...
class phpbbtemplatetwiglexer_000000000c056159000000013887be67 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder587386fabd7bf575515384 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer587386fabd7cf340694432 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties587386fabd785345859399 = array(
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, 'set_environment', array('env' => $env), $this->initializer587386fabd7cf340694432);

        return $this->valueHolder587386fabd7bf575515384->set_environment($env);
    }
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer587386fabd7cf340694432);

        return $this->valueHolder587386fabd7bf575515384->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer587386fabd7cf340694432);

        return $this->valueHolder587386fabd7bf575515384->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer587386fabd7cf340694432 = $initializer;
    }
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__get', array('name' => $name), $this->initializer587386fabd7cf340694432);

        if (isset(self::$publicProperties587386fabd785345859399[$name])) {
            return $this->valueHolder587386fabd7bf575515384->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder587386fabd7bf575515384;
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer587386fabd7cf340694432);
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__isset', array('name' => $name), $this->initializer587386fabd7cf340694432);
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__unset', array('name' => $name), $this->initializer587386fabd7cf340694432);
    ...
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__clone', array(), $this->initializer587386fabd7cf340694432);

        $this->valueHolder587386fabd7bf575515384 = clone $this->valueHolder587386fabd7bf575515384;
    }

    public function __sleep()
    {
        $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, '__sleep', array(), $this->initializer587386fabd7cf340694432);

        return array('valueHolder587386fabd7bf575515384');
    }
    ...
    {
        return $this->initializer587386fabd7cf340694432;
    }
    ...
    {
        return $this->initializer587386fabd7cf340694432 && $this->initializer587386fabd7cf340694432->__invoke($this->valueHolder587386fabd7bf575515384, $this, 'initializeProxy', array(), $this->initializer587386fabd7cf340694432);
    }
    ...
    {
        return null !== $this->valueHolder587386fabd7bf575515384;
    }
    ...
    {
        return $this->valueHolder587386fabd7bf575515384;
    }
